...
public class ExcelDataCreater
{
    ...
    [MenuItem("GameTool/GenerateExcelData/GenerateData")]
    ...
    [MenuItem("GameTool/GenerateExcelData/GeneratePrefs")]
    private static void GeneratePrefs()
    {
        GenerateData(GenerateExcelDataPrefs);
    }
    [MenuItem("GameTool/GenerateExcelData/GenerateXml")]
    private static void GenerateXml()
    {
        GenerateData(GenerateExcelDataXml);
    }
    [MenuItem("GameTool/GenerateExcelData/GenerateJson")]
    private static void GenerateJson()
    {
        GenerateData(GenerateExcelDataJson);
    }
    [MenuItem("GameTool/GenerateExcelData/GenerateBinary")]
